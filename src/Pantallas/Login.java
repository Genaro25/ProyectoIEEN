...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/delete-button.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        LoginManejador nuevo= new LoginManejador();
        
        if(nuevo.valida(usuario.getText(),contra.getText())==false){
            System.out.print("error weeee");
        }else{
            Principal ne= new Principal();
            ne.setVisible(true);
